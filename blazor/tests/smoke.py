    ...
    with sync_playwright() as p:
        ...
        for name, url in urls:
            ...
            try:
                ...
                page.locator('#template-move').click()
                expect(page.locator('#template-counter')).to_have_text('Razor count: 1')
                expect(page.locator('#template-value')).to_have_text('Razor two-way binding')
                page.locator('#template-update').click()
                expect(page.locator('#template-context-label')).to_have_text('Updated native template context')
                page.locator('#template-recreate').click()
                expect(page.locator('#template-context-label')).to_have_text('Recreated native template context')
                page.locator('#template-counter').click()
                expect(page.locator('#template-counter')).to_have_text('Razor count: 2')
